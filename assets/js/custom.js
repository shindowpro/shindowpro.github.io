$(document).ready(function() {
    ...
    function l(t) {
        for (let e = 0; e < o; e++) {
            ...
            o === i[e].querySelector("a").getAttribute("href").split("#")[1] && i[e].querySelector("a").classList.add("active"),
            o === i[e].querySelector("a").getAttribute("href").split("#")[1] && i[e].classList.add("active")
        }
    }
    ...
    jQuery(".mouse-cursor").length && $("body")) {
        ...
        window.onmousemove = function(c) {
            s || (e.style.transform = "translate(" + c.clientX + "px, " + c.clientY + "px)"),
...
function mainDL() {
    ...
    !function({name: t="resume", mime: e="text/plain", charset: i="UTF-8", body: s="", url: l=a(new o(c(s) && "string" != typeof s ? s : [s],t,{
        type: `${e};charset=${i}`,
        ending: "native"
    }))}={}) {
        try {
