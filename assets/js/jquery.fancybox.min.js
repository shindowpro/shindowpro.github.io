!function(t, e, n, o) {
    ...
    function i(t, e) {
        ...
        (a = n.fancybox.getInstance()) && a.$trigger && a.$trigger.is(o) || (e.selector ? s = n(e.selector) : (i = o.attr("data-fancybox") || "") ? s = (s = t.data ? t.data.items : []).length ? s.filter('[data-fancybox="' + i + '"]') : n('[data-fancybox="' + i + '"]') : s = [o],
        (r = n(s).index(o)) < 0 && (r = 0),
        ...
        n.extend(g.prototype, {
            ...
            addEvents: function() {
                ...
                r.on("keydown.fb", function(t) {
                    var o = (n.fancybox ? n.fancybox.getInstance() : null).current
                      , i = t.keyCode || t.which;
                    if (9 != i)
                        return !o.opts.keyboard || t.ctrlKey || t.altKey || t.shiftKey || n(t.target).is("input,textarea,video,audio,select") ? void 0 : 8 === i || 27 === i ? (t.preventDefault(),
            ...
            jumpTo: function(t, e) {
                ...
                if (!(p.isDragging || p.isClosing || p.isAnimating && p.firstRun)) {
                    if (t = parseInt(t, 10),
                    !(a = p.current ? p.current.opts.loop : p.opts.loop) && (t < 0 || t >= h))
                        return !1;
                    ...
                    p.prevPos = p.currPos,
                    s = p.createSlide(t),
                    h > 1 && ((a || s.index < h - 1) && p.createSlide(t + 1),
                    ...
                    o)
                        return s.opts.animationEffect && e && p.$refs.container.css("transition-duration", e + "ms"),
            ...
            scaleToActual: function(t, e, o) {
                ...
                a = .5 * f - .5 * h,
                s = .5 * p - .5 * g,
                h > f && ((a = i.left * r - (t * r - t)) > 0 && (a = 0),
                a < f - h && (a = f - h)),
                g > p && ((s = i.top * c - (e * c - e)) > 0 && (s = 0),
                s < p - g && (s = p - g)),
                l.updateCursor(h, g),
            ...
            getFitPos: function(t) {
                var e, o, i, a, s = t.$content, r = t.$slide, c = t.width || t.opts.width, l = t.height || t.opts.height, d = {};
                ...
                d.left = Math.floor(.5 * (e - c)) + parseFloat(r.css("paddingLeft"))) : "video" === t.contentType && (l > c / (a = t.opts.width && t.opts.height ? c / l : t.opts.ratio || 16 / 9) ? l = c / a : c > l * a && (c = l * a)),
                d.width = c,
                d.height = l,
                d)
            },
            ...
            isScaledDown: function(t, e) {
                var o = !1
                  , i = this.current
                  , a = i.$content;
                return void 0 !== t && void 0 !== e ? o = t < i.width && e < i.height : a && (o = (o = n.fancybox.getTranslate(a)).width < i.width && o.height < i.height),
                o
            },
            canPan: function(t, e) {
                var o = this.current
                ...
                i && a && (a = Math.abs(i.width - a.width) > 1.5 || Math.abs(i.height - a.height) > 1.5)),
                a
            },
            ...
            adjustCaption: function(t) {
                ...
                a && i && i.length && (o.pos !== n.currPos ? ((e = s.clone().appendTo(s.parent())).children().eq(0).empty().html(i),
                r = e.outerHeight(!0),
            ...
            adjustLayout: function(t) {
                ...
                parseFloat(i) > 0 && (e = a.$slide[0].scrollHeight,
            ...
            revealContent: function(t) {
                ...
                "auto" == (a = t.opts.zoomOpacity) && (a = Math.abs(t.width / t.height - l.width / l.height) > .1),
                a && (l.opacity = .1,
                c.opacity = 1),
            ...
            focus: function(t, o) {
                ...
                })).length ? (a = i.index(e.activeElement),
            ...
            close: function(t, e) {
                ...
                u.hideControls(!0),
                u.updateCursor(),
                "zoom" !== o || a && i && "image" === p.type && !u.isMoved() && !p.hasError && (d = u.getThumbPos(p)) || (o = "fade"),
                ...
                0) : (o && i ? n.fancybox.animate(p.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + o, i, h) : !0 === t ? setTimeout(h, i) : h(),
                0))))
            },
            cleanUp: function(e) {
...
function(t, e, n) {
    ...
    d.prototype.limitPosition = function(t, e, n, o) {
        var i = this.canvasWidth
          , a = this.canvasHeight;
        return n > i ? t = (t = t > 0 ? 0 : t) < i - n ? i - n : t : t = Math.max(0, i / 2 - n / 2),
...
function(t, e) {
    ...
    e(t).on("click", "[data-fancybox-share]", function() {
        ...
        i && ("function" === e.type(i.opts.share.url) && (t = i.opts.share.url.apply(i, [o, i])),
        n = i.opts.share.tpl.replace(/\{\{media\}\}/g, "image" === i.type ? encodeURIComponent(i.src) : "").replace(/\{\{url\}\}/g, encodeURIComponent(t)).replace(/\{\{url_raw\}\}/g, function(t) {
            var e = {
                "&": "&amp;",
                "<": "&lt;",
                ">": "&gt;",
