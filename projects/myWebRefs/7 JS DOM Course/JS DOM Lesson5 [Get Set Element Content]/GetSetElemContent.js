...
/* JSOOP [Get Set element Content] */ 
/*template-string-converter.enable;*/

function test() {

    alert("Welcome to {Get Set element Content} application ");
    ...
    if (w!= "1") {
        ...
        do {            
            ...
            alert("Welcome to {get-set Node Elements content} \n Choose your main Path from below");
            
            var path = prompt("Press(1) to {Get - Function} certain element's Text Node  \n " +
            "Press(2) to to {Set-Function} certain element's Text Node  "); 
            
            if (path == "1") {                
                                
                alert("Welcome to [Get certain Element's Text Node Path ]");

                var mthd = prompt("Press (1) for {.innerHTML} Method\n Press (2) for {.textContent} Method ");
                
                if (mthd == "1") {

                    alert("Welcome to [Get certain Element's Text Node - {.innerHTML;} ]");
                    
                    do {
                            
                        var uElem = prompt("Enter your {Parent element}'s Id Name to get Child Element inner HTML inside it"),
                            elem = document.getElementById(uElem),
                            childElemId = prompt("enter your {Child Element}'s id name to get it's HTML Content "),
                            childElem = document.getElementById(childElemId);
    
                        elem.textContent ='\n' + childElem.innerHTML + "\n";
    
                        alert("your parant Element Name is : " , elem.tagName, "your Child Element Name is : " , childElem.tagName, "\n Child HTML Element Content is :" , elem.textContent);
                        
                        console.log("your parant Element Name is : " + elem.tagName + "your Child Element Name is : " + childElem.tagName + "\n Child HTML Element Content is :" + elem.textContent);
                        
                        document.getElementById('txtarea').textContent = "your parant Element Name is : " + elem.tagName + "your Child Element Name is : " + childElem.tagName + "\n Child HTML Element Content is :" + elem.textContent + "\ns" ;                                            
                                                 
                        var z0 =prompt("Press (1) to restart the [Welcome to [Get certain Element's Text Node - {.innerHTML;}] \n"+
                    ...
                    alert("Welcome to [Get certain Element's Text Node - {.textContent;} ]");
                    
                    do {
                            
                        var uElem = prompt("Enter your {Parent element}'s Id Name to get Child Element Content inside it"),
                            elem = document.getElementById(uElem),
                            childElemId = prompt("enter your Child Elment's id name to get it's Textual Content "),
                            childElem = document.getElementById(childElemId);
    
                        elem.textContent ='\n' + childElem.textContent + "\n";
    
                        alert("your parent Element Name is : " , elem.tagName, "\nyour Child Element Name is : " , childElem.tagName, "\n Child Element Content is :" , elem.textContent);
                        
                        console.log("\nyour parent Element Name is : " + elem.tagName + "\nyour Child Element Name is : " + childElem.tagName + "\n Child  Element Content is :" + elem.textContent + "\n") ;
                        
                        document.getElementById('txtarea').textContent = "\nyour parant Element Name is : " + elem.tagName + "\nyour Child Element Name is : " + childElem.tagName + "\n Child Element Content is :" + elem.textContent + "\n" ;                                            
                                                 
                        var z =prompt("Press (1) to restart the [Welcome to [Get certain Element's Text Node - {.textContent;}] \n"+
                        " or any other key to Abort!");
                    } while (z == "1");
        ...
        // =================================================================================================
                ...
                alert("Welcome to [{Set-Function} certain element's Text Node]");                            
                
                do {                    
                    alert("Welcome to [Set certain Element's Text Node Path ]");
                    var mthd = prompt("Press (1) for {.innerHTML} Method\n Press (2) for {.textContent} Method ");
                    
                    if (mthd == "1") {
                        alert("Welcome to [Set certain Element's Text Node - {.innerHTML;} ]");
                        
                        do {
                                
                            var uElem = prompt("Enter your {Parent Element}'s Id Name to Set the Child Element inner HTML inside it"),
                                elem = document.getElementById(uElem),
                                childElemId = prompt("enter your {Child Element}'s id name to Set it's HTML Content "),
                                childElem = document.getElementById(childElemId),
                                newChildCont = prompt("Enter your new {child element} (Textual + HTML) Content to set/replace inside the child element");
                            
                            // Setting the child Element with new HTML Content :
                            childElem.innerHTML = newChildCont;
                            
                            // Setting the Parent Element with the child Element new HTML Content :
                            elem.textContent ='\n' + childElem.innerHTML + "\n";
        
                            alert("your parant Element Name is : " , elem.tagName, "\nyour Child Element Name is : " , childElem.tagName, "\n Child HTML Element new Content is :" , elem.textContent);
                            
                            console.log("your parant Element Name is : " + elem.tagName + "\nyour Child Element Name is : " + childElem.tagName + "\n Child HTML Element new Content is :" + elem.textContent);
                            
                            document.getElementById('txtarea').textContent = "your parant Element Name is : " + elem.tagName + "\nyour Child Element Name is : " + childElem.tagName + "\n Child HTML Element new Content is :" + elem.textContent + "\n" ;                                            
                                                     
                            var z1 =prompt("Press (1) to restart the [Welcome to [Set certain Element's Text Node - {.innerHTML;}] \n"+
                            " or any other key to Abort!");
                        } while (z1 == "1");
                        
                                        
                    } else if (mthd == "2") {                    
                        alert("Welcome to [Set certain Element's Text Node - {.textContent;} ]");
                        
                        do {
                                
                            var uElem = prompt("Enter your element's Id Name to Set the Child Element inner HTML inside it"),
                                elem = document.getElementById(uElem),
                                childElemId = prompt("enter your Child Elment's id name to Set/Change it's HTML Content "),
                                childElem = document.getElementById(childElemId),
                                newChildCont = prompt("Enter your new (Textual only) Content to set inside the child element");
                            
                            // Setting the child Element with new Textual Content :
                            childElem.textContent = newChildCont;

                            // Setting the Parent Element with the child Element new Textual Content :
                            elem.textContent ='\n' + childElem.textContent + "\n";
        
                            alert("your parant Element Name is : " , elem.tagName, "\nyour Child Element Name is : " , childElem.tagName, "\n Child Textual Element new Content is :" , elem.textContent);
                            
                            console.log("your parant Element Name is : " + elem.tagName + "\nyour Child Element Name is : " + childElem.tagName + "\n Child Textual Element new Content is :" + elem.textContent + "\n");
                            
                            document.getElementById('txtarea').textContent = "your parant Element Name is : " + elem.tagName + "\nyour Child Element Name is : " + childElem.tagName + "\n Child Textual Element new Content is :" + elem.textContent + "\n" ;                                            
                                                        
                            var z2 =prompt("Press (1) to restart the [Welcome to [Set certain Element's Text Node - {.textContent;}] \n"+
                            " or any other key to Abort!");
                        } while (z2 == "2");
                    ...
                    var z =prompt("Press (1) to restart the [Set certain Element's Text Node - {.textContent;} ] \n"+
                    " or any other key to Abort!");
