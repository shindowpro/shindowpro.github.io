<!--  103 PHP 5 In Arabic- Outro & Where To Study --> 
<!-- =============================================================== -->

<?php
    
    $lessonName =" Outro & Where To Study";
    $title = '103 PHP5 - ' . $lessonName;
    $css = "103 PHP 5 In Arabic- Outro & Where To Study.css";
    ...
    */            
    ...
    $main =  'In this lesson is an Outro notes lessons and has no Practical Applications] ... ' . '<br>'    
