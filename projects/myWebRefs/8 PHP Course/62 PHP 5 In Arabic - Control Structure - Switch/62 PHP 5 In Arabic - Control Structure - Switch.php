<!--  62 PHP 5 In Arabic - Control Structure - Switch  --> 
<?php
    // include "global.php";
    ...
    $lessonName  ='Control Structure - Switch';
    $title = '62 PHP5 - ' . $lessonName;
    $css = '62 PHP 5 In Arabic - Control Structure - Switch.css';
