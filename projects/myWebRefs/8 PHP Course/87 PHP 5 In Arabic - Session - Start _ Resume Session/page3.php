<?php
    $lessonName  ='Session - Start _ Resume Session ';
    $title = '87 PHP5 - ' . $lessonName;
    $css = '87 PHP 5 In Arabic - Session - Start _ Resume Session.css';

    $heading = 'This the head lesson about ' . $lessonName;
    $paragraph = 'This is paragraph about ' . $lessonName . "<br>";    

    // ============================================================================
    // In this lesson will be (1) Application [Creating 3 pages with session decleratiion , with (3) pages in overall] as following  :
        // 1- First [main page] => Session Defining & Sessions Variables decleration .
        // 2- Second [inner page] => Sessoins Variabes processing .
        // 3- Third [inner page] => Sessoins Variabes processing .
    
    $main =  'In this lesson will be (1) Application [Creating 3 pages with session decleratiion , with (3) pages] as following  : ' . '<br>' . '<ul>' .
    ...
    // (*) => First Example =>  Creating 3 pages with session decleratiion , with (3) pages in overall :
        $ha1 = '{Page-Room 3} : Creating 3 pages with session decleratiion , with (3) pages in overall :  as following : ' . "<br>" ; 
        
        // Declaring the main Session :
            session_start();

            echo 'Hello ' . $_SESSION['username'] . 'Weclome to the web application : [Session] => {Page3 - Room3} '  . "<br>" ;
            
            echo 'You password is ' . $_SESSION['password'] . "<br>" ;
            
            echo 'You in the last page '. "<br>" ;
                        
            // echo '<h1> Click on the link below to go the Room 3 </h1>' . "<br>" ;
...
<html>
        ...
        <body class='body' style="background-color: <?php echo $body; ?>" > 
            ...
            <!-- (*) => First Example =>  Creating 3 pages with session decleratiion , with (3) pages in overall   : -->
                    ...
                    <header>
                        First Example =>  Creating 3 pages with session decleratiion , with (3) pages in overall  : <br> 
                    </header>                                    
