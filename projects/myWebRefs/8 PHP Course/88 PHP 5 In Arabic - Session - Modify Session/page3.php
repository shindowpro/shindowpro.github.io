...
// (*) => First Example =>  Creating 5 pages with session decleration , with (5) pages in overall :
    $ha1 = 'Creating 5 pages with session decleration , with (5) pages in overall + Modifying in the page 4 + with overall printing Session variables :  as following : ' . "<br>" ; 
        ...
        //  User Welcome to the current page  :            
            ...
            echo 'You favorite Food is ' . $_SESSION['favfood'] . "<br>" ;            
                        
        //  Link to the Connected Inner page Number 4 : 
            echo '<h1> Click on the link below to go the Room 4 </h1>' . "<br>" ;

            echo '<a href="page4.php"> Room 4 </a>' . "<br>" ;
...
<html>
        ...
        <body class='body' style="background-color: <?php echo $body; ?>" > 
            ...
            <!-- (*) => First Example =>  Creating 5 pages with session decleration , with (5) pages in overall : -->
                    ...
                    <header>
                        First Example =>  Creating 5 pages with session decleration , with (5) pages in overall  : <br> 
                    </header>                                    
