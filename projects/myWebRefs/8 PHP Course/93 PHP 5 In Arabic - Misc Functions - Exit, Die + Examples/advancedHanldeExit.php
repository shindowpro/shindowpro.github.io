<?php 
    ...
    $ha5 = 'Fifth [Handling file open with exit() + Error Mangement with @ ] : Stop executing the next script in case the file is not exited + displaying customized  as following : ' . "<br>" ; 
    echo 'Welcome to ' . $ha5 ; 
