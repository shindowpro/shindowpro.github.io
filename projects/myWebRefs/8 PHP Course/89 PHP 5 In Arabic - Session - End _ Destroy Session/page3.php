...
<html>
        ...
        <body class='body' style="background-color: <?php echo $body; ?>" > 
            ...
            <!-- (*) => First Example =>  Creating 5 pages with session decleration , with (5) pages in overall  + Unset & Destroy Session File : -->
                        
                    <header>
                        First Example =>  Creating 5 pages with session decleration , with (5) pages in overall + Unset & Destroy Session File  : <br> 
                    </header>                                    
