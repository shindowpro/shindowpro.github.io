...
<?php
    $lessonName  ='Session - Destroy Session ';
    ...
    // ============================================================================
    // In this lesson will be (1) Application [Creating 5 pages with session decleratiion , with (5) pages in overall] as following + Unset & Destroy Session File :
    ...
    $main =  'In this lesson will be (1) Application [Creating 5 pages with session decleratiion + Unset & Destroy Session File , with (5) pages] as following  : ' . '<br>' . '<ul>' .
