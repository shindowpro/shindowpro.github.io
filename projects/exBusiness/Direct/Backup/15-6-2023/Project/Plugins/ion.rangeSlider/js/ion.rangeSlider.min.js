...
; (function (f) {
    ...
    r.prototype = {
                ...
                if (this.coords.w_rs && (this.dragging || this.force_redraw || this.is_key)) {
                    if (this.old_from !== this.result.from || this.old_to !== this.result.to || this.force_redraw || this.is_key) {
                        ...
                        if (this.is_key || this.is_click || this.is_first_update)
                            this.is_first_update = this.is_click = this.is_key = !1,
                                this.callOnFinish();
        ...
        convertToValue: function (a) {
            var b = this.options.min, d = this.options.max, c = b.toString().split(".")[1], e = d.toString().split(".")[1], g, l, f = 0, k = 0;
            if (0 === a)
        ...
        appendGrid: function () {
            if (this.options.grid) {
                ...
                b = a.max - a.min;
                var c = a.grid_num, e, g, f = 4, h, k, m, n = "";
                this.calcGridMargin();
