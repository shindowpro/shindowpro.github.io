...
CloudflareApps.siteId = "0200ba51e0e4bef402a6e60deb31f783";
...
CloudflareApps.installs["0LOcG2nYVAZm"] = { appId: "lMxPPXVOqmoE", scope: {} };
CloudflareApps.installs["0LOcG2nYVAZm"].options = {
  id: "UA-109137088-1",
  social: false,
};
CloudflareApps.installs["0LOcG2nYVAZm"].URLPatterns = [
  "^charlotte.html.themeplayers.net/?.*$",
  "^charlotte.themeplayers.net/?.*$",
  "^daycare.splash.themeplayers.net/?.*$",
  "^daycare.themeplayers.net/?.*$",
  "^diana.html.themeplayers.net/?.*$",
  "^disrupt.html.themeplayers.net/?.*$",
  "^disrupt.splash.html.themeplayers.net/?.*$",
  "^disrupt.themeplayers.net/?.*$",
  "^farmfresh.html.themeplayers.net/?.*$",
  "^farmfresh.splash.html.themeplayers.net/?.*$",
  "^farmfresh.splash.themeplayers.net/?.*$",
  "^farmfresh.themeplayers.net/?.*$",
  "^fishtank.html.themeplayers.net/?.*$",
  "^fishtank.splash.html.themeplayers.net/?.*$",
  "^houses.html.themeplayers.net/?.*$",
  "^houses.splash.html.themeplayers.net/?.*$",
  "^housus.themeplayers.net/?.*$",
  "^kidstuff.themeplayers.net/?.*$",
  "^looksgood.html.themeplayers.net/?.*$",
  "^macaroon.html.themeplayers.net/?.*$",
  "^macaroon.splash.html.themeplayers.net/?.*$",
  "^macaroon.splash.themeplayers.net/?.*$",
  "^macaroon.themeplayers.net/?.*$",
  "^petlovers.splash.themeplayers.net/?.*$",
  "^petlovers.themeplayers.net/?.*$",
  "^puer.themeplayers.net/?.*$",
  "^rota.html.themeplayers.net/?.*$",
  "^rota.themeplayers.net/?.*$",
  "^sella.themeplayers.net/?.*$",
  "^shot.html.themeplayers.net/?.*$",
  "^shot.splash.html.themeplayers.net/?.*$",
  "^themeplayers.net/?.*$",
  "^tourstickets.html.themeplayers.net/?.*$",
  "^www.themeplayers.net/?.*$",
  "^you.splash.themeplayers.net/?.*$",
  "^you.themeplayers.net/?.*$",
];
if (
  CloudflareApps.matchPage(CloudflareApps.installs["0LOcG2nYVAZm"].URLPatterns)
) {
  (function () {
    var options = CloudflareApps.installs["0LOcG2nYVAZm"].options;
    var id;
