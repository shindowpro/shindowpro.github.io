 ...
 */
    ...
    function Fe(t, e) {
        ...
        n && !("" + n).match(Ae) && (console.warn('Invalid font style specified: "' + n + '"'),
        n = "");
        const o = {
    ...
    class yi {
        ...
        _createAnimations(t, e) {
            ...
            for (r = s.length - 1; r >= 0; --r) {
                ...
                d && d.duration ? (o[l] = h = new bi(d,t,l,c),
                n.push(h)) : t[l] = c
            }
            return n
        }
    ...
    class Ti {
        ...
        _dataCheck() {
            ...
            U(i) ? t._data = function(t) {
                ...
                return i
            }(i) : t._data !== i && (t._data && (le(t._data, t),
            Ci(t._cachedMeta)),
    ...
    function zi(t, e) {
        ...
        if (s > 0) {
            ...
            for (Vi(e, l, c, $(n) ? 0 : a - n, a),
            t = 0,
            i = s - 1; t < i; t++)
                Vi(e, l, c, o[t], o[t + 1]);
            return Vi(e, l, c, r, $(n) ? e.length : r + n),
            l
        }
        return Vi(e, l, c),
        l
    ...
    class Yi extends Ri {
        ...
        update(t, e, i) {
            ...
            o.display && (o.autoSkip || "auto" === o.source) && (n.ticks = zi(n, n.ticks),
            n._labelSizes = null),
        ...
        fit() {
            ...
            if (a) {
                ...
                e.height = Hi(s) + a) : (e.height = t.maxHeight,
                e.width = Hi(s) + a),
        ...
        _computeLabelItems(t) {
            ...
            b = r.length; x < b; ++x) {
                ...
                const i = D / 2
                  ...
                  , h = t.textStrokeWidth;
                a ? (v = k,
                C = "top" === o ? "near" === c || 0 !== p ? -D * P + P / 2 : "center" === c ? -A.highest.height / 2 - i * P + P : -A.highest.height + P / 2 : "near" === c || 0 !== p ? P / 2 : "center" === c ? A.highest.height / 2 - i * P : A.highest.height - D * P,
                d && (C *= -1)) : (w = k,
                C = (1 - D) * P / 2),
                m.push({
                    rotation: p,
        ...
        drawGrid(t) {
            ...
            if (a) {
                const t = s.lineWidth
                  , i = e._borderValue;
                let n, r, l, c;
                e.isHorizontal() ? (n = Ut(o, e.left, a) - a / 2,
                r = Ut(o, e.right, t) + t / 2,
                l = c = i) : (l = Ut(o, e.top, a) - a / 2,
    ...
    function en(t, e, i, n) {
        ...
        r.add(n);
        let l = nn(r, a, i, s || i);
        return null !== l && ((!ht(s) || s === i || (l = nn(r, a, s, l),
        null !== l)) && Ui([...r], [""], o, s, (()=>{
    ...
    function cn(t) {
        ...
        !function(t, e, i) {
            ...
            for (let h = 0; h < n - 1; ++h)
                l = c,
                c = rn(t, h + 1),
                l && c && (At(e[h], 0, an) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h],
                s = i[h + 1] / e[h],
    ...
    function dn(t, e, i, n) {
        ...
        e.capBezierPoints && function(t, e) {
            ...
            n = t.length; i < n; ++i)
                ...
                r = i < n - 1 && Kt(t[i + 1], e),
                s && (o = t[i],
                a && (o.cp1x = hn(o.cp1x, e.left, e.right),
                o.cp1y = hn(o.cp1y, e.top, e.bottom)),
                r && (o.cp2x = hn(o.cp2x, e.left, e.right),
    ...
    function qn(t) {
        return Xn() && "string" == typeof t ? t = document.getElementById(t) : t && t.length && (t = t[0]),
    ...
    class Zn {
        ...
        _handleEvent(t, e) {
            ...
            i._lastEvent = null,
            Kt(t, i.chartArea, i._minPadding) && (Q(o.onHover, [t, r, i], i),
    ...
    function xo(t, e) {
        ...
        t.arc(s, a, r, i - c, n + c),
        l > o ? (c = o / l,
        t.arc(s, a, l, n + c, i - c, !0)) : t.arc(s, a, o, n + wt, i - wt),
        t.closePath(),
        t.clip()
    }
    function bo(t, e, i, n) {
    ...
    function vo(t, e) {
        ...
        i.borderWidth && (n ? (t.lineWidth = 2 * i.borderWidth,
    ...
    function Io(t) {
        ...
        const i = {};
        return e ? (e = t.horizontal ? Fo(e, "left", "right", t.base > t.x) : Fo(e, "bottom", "top", t.base < t.y),
        i[e] = !0,
        i) : i
    }
    function Fo(t, e, i, n) {
        var o, s, a;
        return n ? (a = i,
        t = zo(t = (o = t) === (s = e) ? a : o === a ? s : o, i, e)) : t = zo(t, e, i),
        t
    }
    function zo(t, e, i) {
        ...
        beforeElementsUpdate: (t,e,i)=>{
            ...
            t.data.datasets.forEach(((e,o)=>{
                ...
                let h, {start: d, count: u} = function(t, e) {
                    ...
                    return l && (o = Nt(ne(e, s.axis, a).lo, 0, i - 1)),
    ...
    var cs = {
        ...
        beforeDatasetsDraw(t, e, i) {
            ...
            for (let e = n.length - 1; e >= 0; --e) {
                const s = n[e].$filler;
                s && (s.line.updateControlPoints(o),
        ...
        _draw() {
            ...
            t.legendItems.forEach(((e,M)=>{
                ...
                let D = m.x
                  , C = m.y;
                h.setWidth(t.width),
                y ? M > 0 && D + P + f > t.right && (C = m.y += w,
                m.line++,
                D = m.x = o(r, t.left + f, t.right - n[m.line])) : M > 0 && C + w > t.bottom && (D = m.x = D + i[m.line].width + f,
                m.line++,
    ...
    class Ts extends Yi {
        ...
        buildTicks() {
            ...
            const o = function(t, e) {
                ...
                x <= o && v++,
                At(Math.round((x + v * y) * m) / m, o, y / 10) && v++); v < _; ++v)
                    i.push({
        ...
        buildTicks() {
            const t = this
              ...
              , i = function(t, e) {
                ...
                } while (a < i || a === i && r < n);const c = q(t.max, s);
                return o.push({
                    value: c,
                    major: Ls(s)
                }),
    ...
    function Ys(t, e) {
        ...
        null === r ? null : (s && (r = "week" !== s || !Ot(a) && !0 !== a ? i.startOf(r, s) : i.startOf(r, "isoWeek", a)),
        +r)
    }
    function Us(t, e, i, n) {
        const o = js.length;
    ...
    class Ks extends Yi {
        ...
        _generate() {
            ...
            u++)
                Xs(h, d, g);
            return d !== n && "ticks" !== o.bounds && 1 !== u || Xs(h, d, g),
    ...
    return Zn.register(mo, Qs, jo, Cs),
    Zn.helpers = {
        ...Pn
    },
    Zn._adapters = io,
